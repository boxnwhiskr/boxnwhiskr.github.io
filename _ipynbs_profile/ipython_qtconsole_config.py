...
# c.InlineBackend.rc = {'figure.figsize': (6.0, 4.0), 'figure.edgecolor': (1, 1, 1, 0), 'font.size': 10, 'figure.subplot.bottom': 0.125, 'savefig.dpi': 72, 'figure.facecolor': (1, 1, 1, 0)}
