...
['이탈 기준 정하기'](/2014/09/15/make_a_criterion_for_churn.html)에서 데이터를 이용해 적절한 이탈 기준을 살펴보았다.
그리고 ['개별 사용자를 고려한 이탈 측정하기'](/2014/11/11/measure_churn_for_individual_users.html)에서 유저 개인의 접속 특성을 고려한 이탈 척도를 살펴보았다.
...
이 기준은 ['이탈 기준 정하기'](/2014/09/15/make_a_criterion_for_churn.html)의 내용을 참고하여 결정하는데, 해당 예제에서는 임의로 결정하였다.
...
만약 두 개 이상의 서비스를 제공하는 경우라면, 개별 서비스마다 각각 이탈 곡선을 그릴 수 있다.
