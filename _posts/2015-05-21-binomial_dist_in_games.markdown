...
확률 값은 [R](http://www.r-project.org/)을 이용하여 아래와 같이 계산한다.
...
플레이어가 10만원을 투자해서 +10강 무기를 만들 수 있도록 난이도를 조절할 것인지 결정하는 것은 기획자의 몫이다.
...
아래는 강화에 성공한 플레이어만 집계한 비용 누적 분포다.
...
다항 분포를 활용해 확률형 아이템을 설명하는 내용은 ['확률형 아이템을 위한 다항분포'](/2015/06/04/multinomial_dist_for_gachas.html)에서 다룬다.
...
*   관련 발표 - [PyCon KR 2017: 온라인 게임에서의 이항 분포](https://youtu.be/X-5E3KP4PHs)
*   관련 글 - [확률형 아이템을 위한 다항분포](/2015/06/04/multinomial_dist_for_gachas.html)
